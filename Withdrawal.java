...
public class Withdrawal extends JFrame implements ActionListener {
    ...
    public Withdrawal(String accNo) {
        ...
        btnWthDr.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(src == btnWthDr) {
            try {
                ...
                int wdAmt = Integer.parseInt(amt);

                if((balance > wdAmt) && (wdAmt > 0)) {
                    con = new DBConn();
                    int newBal = balance - wdAmt;
                    ...
                    String q2 = "INSERT INTO ClientAccLogs (Date_Time, AccountNo, Action_, Remarks_) VALUES ('" + curDateTime + "', '" + accNo + "', 'WITHDRAWN AMOUNT OF " + wdAmt + "', '-----')";
